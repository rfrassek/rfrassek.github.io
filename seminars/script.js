...
// Define the seminars variable with sample data
    ...
    // Sample seminar data
  var seminars = [
{ date: '08/09/2025', speaker: 'Samuel Belliard',affiliation: 'LMPT (Tours)', title: 'Applications of the Modified Algebraic Bethe Ansatz'    , abstract:  'We present recent applications of the Modified Algebraic Bethe Ansatz (MABA) to two-dimensional vertex models and one-dimensional spin chains. First, we address the eigenvalue problem and scalar products within the MABA framework. In particular, we exploit the SL₂ invariance of the underlying R-matrix and introduce a modified representation theory that generalizes the conventional highest-weight formalism. Next, we study the rectangular 6-vertex model with general boundary conditions (r6V-GBC), characterized by modified creation operators in the MABA and pseudo vectors from modified representation theory. We analyze both the homogeneous and thermodynamic limits, deriving boundary effects on the leading term of the free energy. Finally, by applying the MABA to two distinct twists and using modified Slavnov scalar products, we obtain the Full Counting Statistics (FCS) for the XXX twisted spin chain. This work was conducted in collaboration with R. Pimenta, N. Slavnov, B. Vallet, M. Cornillault and A. Hutsalyuk.'   },
...
{ date: '07/05/2024', speaker: 'Gunter Schütz',affiliation: 'Lisbon', title:  'Reverse duality for the conditioned asymmetric simple exclusion process'   , abstract:  'Reverse duality is a time-reversed version of conventional duality that describes the time evolution of the measure of a Markov processin terms of the time evolution of the measure of the dual process. In this talk it is used to study the asymmetric simple exclusion process (ASEP) on a finite one-dimensional torus and conditioned on an atypically low current. We prove that the time evolution of a family of inhomogeneous shock measures is given by the transition probability of single biased random walk. The origin of this reverse duality are intertwining relations of the conditioned generator of the ASEP with representations of the quantum algebra $U_q(\mathfrak{su}_2)$ originally proved by Pasquier and Saleur in 1990 and which can extended to $U_q(\mathfrak{sl}_2(\R)$ to cover the case of the ASEP. The relation to the dynamical phase transition of the ASEP condition on a low current discovered by Bodineau and Derrida in 2005 and extensions of reverse duality to the open conditioned ASEP and to multiple shocks are also discussed. (Joint work with V. Belitsky)'   },

{ date: '11/04/2024', speaker: 'Andrea Cavaglià',affiliation: 'Torino', title: 'Studying N=4 super Yang-Mills theory with integrability and conformal bootstrap'    , abstract:   'I will discuss an interplay between two different methods, namely integrability and the numerical conformal bootstrap, to study of N=4 Super Yang-Mills theory. On the integrability side, I will describe an exact method to compute exactly the spectrum of the theory by solving a complex analysis problem, known as quantum spectral curve. Then, we will see how the knowledge of the spectrum, joined with local constraints typical of conformal field theories, allows to bootstrap with great precision other more complicated observables, for example the value of a 4-point correlator. The setup considered will be the one of observables living on a supersymmetric Wilson line. Based on works with N. Gromov, J. Julius, M. Preti and N. Sokolova.'  },

{ date: '10/04/2024', speaker: 'Nicolò Primi',affiliation: 'Torino', title: 'Form factors for integrable spin chains via Separation of Variables'    , abstract:   'We introduce Functional Separation of Variables (FSoV) in integrable spin chains based on the Yangian Y(gl(N)). This technique allows to compute scalar products between any of the so-called factorisable state, including all eigenvectors of the tower of conserved charges, in a compact determinant form. We show how to use FSoV to compute form factors of a complete basis of operators of the spin chain. We do so by defining the Principal Operators, a special family of operators that generate the full Yangian symmetry. Using the new technique of Character Projection, we show that off-diagonal form factors of the Principal Operators can also be expressed as determinants. Finally, we explicitly obtain matrix elements of the same principal operators on the so-called SoV basis. These can be used to obtain form factors of any number of insertions of principal operators, giving access to spin chain correlation functions. We conclude by briefly discussing the application of FSoV to open spin chain based on representations of the twisted Yangians.'  },
...
{ date: '13/11/2023', speaker: 'Cristian Giardinà',affiliation: 'Modena', title: 'Exactly solvable models of energy transport: from micro to macro', abstract: 'n/a' },
